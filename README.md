[![Linux](https://dev.azure.com/flatsurf/conda/_apis/build/status/flatsurf.intervalxt?branchName=master&jobName=linux&configuration=linux%20build_linux_)](https://dev.azure.com/flatsurf/conda/_build/latest?definitionId=&branchName=master)
...
* **libintervalxt** [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/flatsurf/intervalxt/master?filepath=binder%2FSample.ipynb)
...
conda create -n intervalxt-build cxx-compiler libtool automake boost-cpp e-antic gtest benchmark ccache
